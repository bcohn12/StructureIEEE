...
Here we present a novel application of the well-known Hit-and-Run algorithm \cite{} to describe the internal structure of these high-dimensional polytopes of feasible muscle activation patterns. We used a published model 
\begin{itemize}
